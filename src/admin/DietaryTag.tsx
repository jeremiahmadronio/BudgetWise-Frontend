...
type ViewMode = 'overview' | 'tagging' | 'quality'
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {filteredProducts.map((product) => (
                <tr key={product.productId} className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="px-3 md:px-6 py-3 md:py-4 whitespace-nowrap">
                    <div className="text-xs md:text-sm text-gray-900">{product.category}</div>
                  </td>
                  <td className="px-3 md:px-6 py-3 md:py-4 whitespace-nowrap">
                  ...
                  <td className="px-3 md:px-6 py-3 md:py-4 whitespace-nowrap text-right text-xs md:text-sm font-medium">
                    ...
                    >
                      {product.tags.length === 0 ? 'Add Tags' : 'Edit Tags'}
                    </button>
                  </td>
                </tr>
              ))}
      ...
      <div className="bg-white border border-gray-200 rounded-xl overflow-hidden shadow-md">
        <div className="overflow-x-auto">
          <table className="w-full text-sm">
            <thead className="bg-gray-50">
              <tr>
                <th className="w-12 px-3 md:px-6 py-2 md:py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                  <input
                    type="checkbox"
                ...
                <th className="w-20 px-3 md:px-6 py-2 md:py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                  ID
                </th>
                <th className="px-3 md:px-6 py-2 md:py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                  Tag Name
                ...
                <th className="w-28 px-3 md:px-6 py-2 md:py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider">
                  Actions
                </th>
              </tr>
            </thead>
            <tbody className="bg-white divide-y divide-gray-200">
              {filteredTags.map((tag) => (
                <tr key={tag.id} className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="px-3 md:px-6 py-3 md:py-4 whitespace-nowrap">
                    <div className="text-xs md:text-sm font-medium text-gray-900">{tag.tagName}</div>
                  </td>
                  ...
                  <td className="px-3 md:px-6 py-3 md:py-4 whitespace-nowrap">
                    <div className="text-xs md:text-sm text-gray-600">{formatDate(tag.updatedAt)}</div>
                  </td>
                  <td className="px-3 md:px-6 py-3 md:py-4 whitespace-nowrap text-right text-xs md:text-sm font-medium">
                    <button
                      onClick={() => onEdit(tag)}
              ...
              {paginatedIssues.map((issue) => (
                <>
                  <tr key={issue.productId} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-3 md:px-6 py-3 md:py-4 whitespace-nowrap">
                      <div className="text-xs md:text-sm font-medium text-gray-900">{issue.productName}</div>
                    </td>
                    <td className="px-3 md:px-6 py-3 md:py-4 whitespace-nowrap">
                      <div className="text-xs md:text-sm text-gray-600">{issue.category}</div>
                    </td>
                    <td className="px-3 md:px-6 py-3 md:py-4 whitespace-nowrap">
                      <div className="text-xs md:text-sm text-gray-900">{issue.issueType}</div>
                    </td>
                    <td className="px-3 md:px-6 py-3 md:py-4 whitespace-nowrap">
                    ...
                    <td className="px-3 md:px-6 py-3 md:py-4 whitespace-nowrap">
                      <div className="text-xs md:text-sm text-gray-600">{formatDate(issue.lastUpdated)}</div>
                    </td>
                    <td className="px-3 md:px-6 py-3 md:py-4 whitespace-nowrap text-center">
                      <button
                        onClick={() => toggleRow(issue.productId)}
                        className="inline-flex items-center justify-center w-8 h-8 rounded-lg bg-blue-50 text-blue-600 hover:bg-blue-100 hover:text-blue-700 transition-all"
                        title="View details"
                      >
                        <svg
                          className={`h-5 w-5 transition-transform duration-200 ${expandedRows.has(issue.productId) ? 'rotate-180' : ''}`}
                          fill="none"
                          viewBox="0 0 24 24"
                          stroke="currentColor"
                        >
                  ...
                  {expandedRows.has(issue.productId) && (
                    <tr key={`${issue.productId}-details`} className="bg-gray-50">
                      <td colSpan={7} className="px-3 md:px-6 py-4">
                        <div className="space-y-4">
                          ...
                          <div className="bg-green-50 rounded-lg p-4 border border-green-200">
                            ...
                            <p className="text-sm text-green-800 font-medium">{issue.suggestedFix}</p>
                          </div>
                          
                          <div className="bg-white rounded-lg p-4 border border-gray-200">
                            <h4 className="text-xs font-semibold text-gray-700 uppercase tracking-wider mb-2">Current Tags</h4>
                            {issue.currentTags.length > 0 ? (
                              <div className="flex flex-wrap gap-2">
                                {issue.currentTags.map((tag, index) => (
                          ...
                          <div className="flex justify-end pt-2">
                            <button
                              ...
                              className="inline-flex items-center gap-2 px-6 py-2.5 bg-blue-600 text-white rounded-lg text-sm font-medium hover:bg-blue-700 transition-colors shadow-sm"
                            >
                              <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
